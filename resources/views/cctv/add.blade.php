...
@section('content')
    ...
    <div class="container">
            ...
            <div class="col-sm-3">
                ...
                <div class="text-center">
                    <img id="myImg"
                        ...
                        class="avatar img-thumbnail" style="max-height: 188px; overflow: hidden;" alt="avatar">
                </div>
            </div>
            <!--/col-3-->
            <div class="col-sm-9">
                <div class="tab-pane active" id="home">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            ...
                            <input type="text" class="form-control" name="birthdate" id="birthdate" placeholder="birthdate"
                                title="enter your birthdate if any.">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-4">
                            <label for="title">คำนำหน้าชื่อ</label>
                            <input type="text" class="form-control" name="title" id="title" placeholder="คำนำหน้าชื่อ"
                    ...
                    <div class="form-group">
                        <div class="col-xs-4">
                            ...
                            <input type="text" class="form-control" name="title_en" id="title_en" placeholder="title name"
                                title="enter your title if any.">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <input type="text" class="form-control" name="location" id="location" placeholder="some place"
        ...
        @push('script')
            ...
            <script type="text/javascript" src="{{ asset('asset/js/reconnecting-websocket.js') }}"></script>
